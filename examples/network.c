...
int main(void)
{
    ...
    Rule* rules[] = {
        rule_alloc(2,
            rule_lit(R_1, data_anchor_ratio, R_EQUALS),
            rule_lit(R_2, data_ale, R_STOP)),
        rule_alloc(2,
            rule_lit(R_3, data_node_density, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
        rule_alloc(2,
            rule_lit(R_0, data_trans_range, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
        rule_alloc(2,
            rule_lit(R_3, data_iterations, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
        rule_alloc(2,
            rule_lit(R_1, data_iterations, R_EQUALS),
            rule_lit(R_2, data_ale, R_STOP)),
        rule_alloc(3,
            rule_lit(R_0, data_anchor_ratio, R_AND),
            rule_lit(R_0, data_trans_range, R_EQUALS),
            rule_lit(R_2, data_ale, R_STOP)),
        rule_alloc(3,
            rule_lit(R_2, data_anchor_ratio, R_AND),
            rule_lit(R_1, data_trans_range, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
        rule_alloc(3,
            rule_lit(R_3, data_node_density, R_AND),
            rule_lit(R_3, data_iterations, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
        rule_alloc(3,
            rule_lit(R_1, data_anchor_ratio, R_AND),
            rule_lit(R_1, data_node_density, R_EQUALS),
            rule_lit(R_2, data_ale, R_STOP)),
        rule_alloc(3,
            rule_lit(R_3, data_anchor_ratio, R_AND),
            rule_lit(R_3, data_trans_range, R_EQUALS),
            rule_lit(R_0, data_ale, R_STOP)),
        rule_alloc(3,
            rule_lit(R_1, data_anchor_ratio, R_AND),
            rule_lit(R_3, data_iterations, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
        rule_alloc(4,
            rule_lit(R_1, data_anchor_ratio, R_AND),
            rule_lit(R_3, data_trans_range, R_AND),
            rule_lit(R_3, data_iterations, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
        rule_alloc(4,
            rule_lit(R_1, data_anchor_ratio, R_AND),
            rule_lit(R_2, data_trans_range, R_AND),
            rule_lit(R_3, data_node_density, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
        rule_alloc(4,
            rule_lit(R_3, data_anchor_ratio, R_AND),
            rule_lit(R_1, data_node_density, R_AND),
            rule_lit(R_3, data_iterations, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
        rule_alloc(4,
            rule_lit(R_2, data_anchor_ratio, R_AND),
            rule_lit(R_2, data_trans_range, R_AND),
            rule_lit(R_2, data_iterations, R_EQUALS),
            rule_lit(R_2, data_ale, R_STOP)),
        rule_alloc(4,
            rule_lit(R_2, data_anchor_ratio, R_AND),
            rule_lit(R_2, data_node_density, R_AND),
            rule_lit(R_2, data_iterations, R_EQUALS),
            rule_lit(R_2, data_ale, R_STOP)),
        rule_alloc(4,
            rule_lit(R_2, data_trans_range, R_AND),
        ...
        rule_alloc(5,
            rule_lit(R_3, data_anchor_ratio, R_AND),
            rule_lit(R_1, data_trans_range, R_AND),
            rule_lit(R_1, data_node_density, R_AND),
            rule_lit(R_1, data_iterations, R_EQUALS),
            rule_lit(R_2, data_ale, R_STOP)),
        rule_alloc(5,
            rule_lit(R_2, data_anchor_ratio, R_AND),
            rule_lit(R_2, data_trans_range, R_AND),
            rule_lit(R_2, data_node_density, R_OR),
            rule_lit(R_2, data_iterations, R_EQUALS),
            rule_lit(R_2, data_ale, R_STOP)),
        rule_alloc(5,
            rule_lit(R_1, data_anchor_ratio, R_AND),
        ...
        rule_alloc(5,
            rule_lit(R_3, data_anchor_ratio, R_AND),
            rule_lit(R_3, data_trans_range, R_AND),
            rule_lit(R_1, data_node_density, R_OR),
            rule_lit(R_3, data_iterations, R_EQUALS),
            rule_lit(R_1, data_ale, R_STOP)),
    };
